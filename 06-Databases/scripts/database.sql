...
-- ('','','');
-- INSERT INTO `users_data` (`id`,`name`,`lastname`,`register_date`,`last_login`,`birth_date`,`email`,`phone`,`city`,`country`,`address`) VALUES
-- ('','','','','','','','','','','');
-- INSERT INTO `payments` (`id`,`type`,`user`,`date_in`,`date_out`,`app_count`) VALUES
-- ('','','','','','');